...
- **Date (UTC):** 2026-08-25 00:42
- **Upstream:** [`12998cb`](https://github.com/meshcore-dev/MeshCore/commit/12998cba8969e4004d94ed94b5e8e5bbdfa05571) on [`dev`](https://github.com/meshcore-dev/MeshCore/tree/dev)
- **Companion:** [ok](https://github.com/marcelverdult/meshcore-nightly/releases/tag/nightly-companion-20260825)
- **Repeater:** failed
- **Room server:** failed
