...
- **Date (UTC):** 2026-08-21 00:44
- **Upstream:** [`e003187`](https://github.com/meshcore-dev/MeshCore/commit/e0031870f6e94657765a77e5f7676654d465dd86) on [`dev`](https://github.com/meshcore-dev/MeshCore/tree/dev)
- **Companion:** [ok](https://github.com/marcelverdult/meshcore-nightly/releases/tag/nightly-companion-20260821)
- **Repeater:** failed
- **Room server:** failed
...
|------|-----------|----------|-------------|
| 2026-08-21 | [ok](https://github.com/marcelverdult/meshcore-nightly/releases/tag/nightly-companion-20260821) | failed | failed |
