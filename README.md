...
- **Date (UTC):** 2026-08-20 00:41
- **Upstream:** [`67d6d42`](https://github.com/meshcore-dev/MeshCore/commit/67d6d42a4c1cc57196e00817a2c2271dffe24cc6) on [`dev`](https://github.com/meshcore-dev/MeshCore/tree/dev)
- **Companion:** [ok](https://github.com/marcelverdult/meshcore-nightly/releases/tag/nightly-companion-20260820)
- **Repeater:** failed
- **Room server:** failed
...
|------|-----------|----------|-------------|
| 2026-08-20 | [ok](https://github.com/marcelverdult/meshcore-nightly/releases/tag/nightly-companion-20260820) | failed | failed |
