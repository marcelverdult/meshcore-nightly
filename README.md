...
- **Date (UTC):** 2026-08-04 01:42
- **Upstream:** [`8b9bee3`](https://github.com/meshcore-dev/MeshCore/commit/8b9bee3bb79d7bd506564363af8f5d79b457282b) on [`dev`](https://github.com/meshcore-dev/MeshCore/tree/dev)
- **Companion:** [ok](https://github.com/marcelverdult/meshcore-nightly/releases/tag/nightly-companion-20260804)
- **Repeater:** failed
- **Room server:** [ok](https://github.com/marcelverdult/meshcore-nightly/releases/tag/nightly-room-server-20260804)
